...
<?php get_header(); ?>
	...
	<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		<div class="Content Content--app u-gridContainer" id="post-<?php the_ID(); ?>">
			<h2><?php the_title(); ?></h2> 
			<div>
				...
				<article class="Content-article u-gridCol8" id="post-<?php the_ID(); ?>">
					...
					<p>
					<a href="https://play.google.com/store/apps/details?id=com.wZeisterStukadoors" target="_blank">Download de app hier</a>
					</p>


					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/qr_code.png" width="400" />
